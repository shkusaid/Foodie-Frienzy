...
export const AboutHome = () => {
  return (
    <div className=" min-h-screen bg-gradient-to-br from-[#1a1212] to-[#2a1e1e]  text-white py-10 sm:py-20 relative overflow-hidden">
      ...
      <div className=" container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center lg:gap-8 xl:gap-16 relative">
        <div className=" w-full order-1 lg:order-2 space-y-8 sm:space-y-12 relative">
          <div className=" space-y-4 sm:space-y-8 px-4 sm:px-0">
            <h2 className="text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-bold leading-tight">
              <span className=" font-cursive text-4xl sm:text-5xl  md:text-6xl bg-gradient-to-r from-amber-400 to-amber-500 bg-clip-text text-transparent">
                Epicurean Elegence
              </span>{" "}
              <br />
            ...
            <p className=" text-base sm:text-lg md:text-xl opacity-90 leading-relaxed max-w-3xl font-serif italic border-1-4 bg-amber-500/60 pl-4 sm:pl-4  py-2  bg-gradient-to-r from-white/5 to-transparent capitalize">
              {" "}
              in our kitchen , passion meets precision . we crafts not just
              meals , but culinary journey's that linger on palate and in the
              hearts
            </p>
          </div>
          ...
          <div className=" flex flex-wrap gap-4 mt-6 sm:mt-8 px-4 sm:px-0">
            <Link
              to={"/about"}
            ...
            >
              <span className=" absolute inset-0 bg-gradient-to-r  from-amber-600 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
              <FaInfoCircle className=" text-lg sm:text-xl animate-pulse" />
              <span className=" font-cursive text-lg sm:text-xl capitalize">
                {"unveil our legacy "}
              </span>{" "}
            </Link>
          </div>
        ...
        <div className=" w-full order-2 lg:order-1 md:max-w-md lg:max-w-none lg:w-7/12 mt-12 mb-10 lg:mb-0 relative group  transform hover:scale-[1.01] transition-all duration-500">
          <div className=" relative rounded-[4rem] overflow-hidden border-4 border-amber-900/30 hover:border-amber-600/40 transition-all duration-500 shadow-2xl shadow-black/50">
            <div className=" absolute inset-0 bg-gradient-to-br from-amber-400/15 via-transparent to-amber-600/15 " />
            <img
              src={AboutImage}
              alt="restaurent"
              className=" w-full h-auto  object-cover aspect-[3/4] transform -rotate-1 hover:rotate-0 transition-all duration-300"
            />
